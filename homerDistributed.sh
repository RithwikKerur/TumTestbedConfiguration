...
cd ./target/release
tmux new -d -s primary "./node -vvv run --keys /root/TumTestbedConfiguration/node-1.json --committee /root/TumTestbedConfiguration/committee.json --store ./db-1 --parameters /root/TumTestbedConfiguration/parameters.json primary |& tee primary.log"
tmux new -d -s client "./benchmark_client 172.16.1.1:3004 --size 512 --burst 50 --rate 10000 --nodes 172.16.3.1:3004 172.16.1.1:3004 172.16.6.1:3004 2>&1 | tee client.log"
